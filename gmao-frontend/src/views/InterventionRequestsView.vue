...
<template>
  <div class="di-page">
    <header class="page-header">
      ...
      <button class="btn btn-success" @click="openCreateModal" v-if="authStore.hasPermission('intervention_request:create')">
        ...
        <div class="request-actions">
          ...
          <template v-if="req.status === 'pending'">
            <button 
              ...
              @click="openValidateModal(req, 'approve')"
      ...
      <div class="modal">
        ...
        <form @submit.prevent="createRequest" class="modal-body">
          ...
          <div class="form-group">
            ...
            <div class="asset-type-selector">
              <label 
                ...
                :class="{ active: form.asset_type === 'equipment' }"
              >
                <input 
                  type="radio" 
              ...
              <label 
                class="asset-type-option" 
                :class="{ active: form.asset_type === 'truck' }"
              >
                <input 
                  type="radio" 
                  v-model="form.asset_type" 
          ...
          <div class="form-group">
            ...
            <textarea v-model="form.description" required rows="4" placeholder="Décrivez le problème observé..."></textarea>
          </div>
          ...
          <div class="form-row">
            <div class="form-group">
              ...
              <select v-model="form.urgency" required>
                ...
                <option value="medium">Moyenne - À traiter cette semaine</option>
          ...
          <div class="form-group">
            ...
            <input type="text" v-model="form.location_details" :placeholder="form.asset_type === 'truck' ? 'Ex: Parking principal, sur route...' : 'Ex: Près de l\'entrée, niveau 2...'" />
          </div>
      ...
      <div class="modal modal-large">
        ...
        <div class="modal-body" v-if="selectedRequest">
          ...
          <div class="detail-grid">
            <!-- Info Asset -->
            <div class="detail-item asset-detail" v-if="selectedRequest.asset_type === 'equipment' && selectedRequest.equipment">
            ...
            <div class="detail-item asset-detail" v-if="selectedRequest.asset_type === 'truck' && selectedRequest.truck">
          ...
          <div class="detail-section" v-if="selectedRequest.work_order">
            ...
            <div class="ot-link">
              ...
              <span class="ot-status" :style="getStatusStyle(selectedRequest.work_order.status)">
                {{ selectedRequest.work_order.status }}
              </span>
            </div>
          </div>

          <!-- Actions -->
          <div class="detail-actions" v-if="selectedRequest.status === 'pending' || selectedRequest.status === 'approved'">
            <button 
              class="btn btn-success" 
              @click="openValidateModal(selectedRequest, 'approve')"
            ...
            <button 
              ...
              @click="openValidateModal(selectedRequest, 'reject')"
              v-if="selectedRequest.status === 'pending' && authStore.hasPermission('intervention_request:validate')"
            >
              ✕ Rejeter
            </button>
            <button 
              class="btn btn-info" 
              @click="openConvertModal(selectedRequest)"
      ...
      <div class="modal modal-small">
        ...
        <form @submit.prevent="validateRequest" class="modal-body">
          ...
          <div class="modal-footer">
            ...
            <button type="submit" class="btn" :class="validateForm.action === 'approve' ? 'btn-success' : 'btn-danger'" :disabled="saving">
...
.asset-type-option.active .option-content,
.asset-type-option:hover .option-content {
  border-color: #3498db;
  background: #f0f7ff;
}
...
.badge.asset-badge.truck {
  background: #e3f2fd;
  color: #1565c0;
}

.badge.asset-badge.equipment {
  background: #f3e5f5;
  color: #7b1fa2;
}
