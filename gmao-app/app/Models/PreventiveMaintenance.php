...
class PreventiveMaintenance extends Model
{
    ...
    public function getIsDueAttribute(): bool
    {
        ...
        // Vérifier par kilométrage (camions)
    ...
    public function getIsDueSoonAttribute(): bool
    {
        ...
        // Vérifier par date (dans les X jours d'avance)
        ...
        // Vérifier par kilométrage (dans les X km d'avance)
    ...
    public static function generateCode(): string
    {
        ...
        return sprintf('PM-%s-%04d', $year, $count);
    }
    ...
    public function calculateNextExecutionDate(): ?Carbon
    {
        ...
        $nextDate = match ($this->frequency_type) {
            ...
            'mileage' => null, // Basé sur kilométrage, pas sur date
            default => null,
        };
