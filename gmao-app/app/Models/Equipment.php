...
class Equipment extends Model
{
    ...
    protected $fillable = [
        ...
        'department',           // ← Ajouté
        'criticality',          // ← Ajouté
        'installation_date',    // ← Ajouté
        'warranty_expiry_date', // ← Ajouté
        'description',          // ← Ajouté
        'acquisition_date',
        'acquisition_cost',
        'warranty_expiry',
    ...
    protected $casts = [
        ...
        'warranty_expiry_date' => 'date',   // ← Ajouté
        'installation_date' => 'date',       // ← Ajouté
    ...
    public function getStatusLabelAttribute(): string
    {
        $labels = [
            ...
            'degraded' => 'Dégradé',           // ← Ajouté
            'stopped' => 'Arrêté',             // ← Ajouté
    ...
    public function getAlertsAttribute(): array
    {
        ...
        // Alerte garantie (supporte les deux champs)
