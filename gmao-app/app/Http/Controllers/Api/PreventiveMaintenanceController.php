...
class PreventiveMaintenanceController extends Controller
{
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        // Calculer next_execution_date ou next_mileage
    ...
    public function generateWorkOrder(Request $request, PreventiveMaintenance $preventiveMaintenance): JsonResponse
    {
        ...
        $workOrder = DB::transaction(function () use ($preventiveMaintenance, $request, $validated) {
            ...
            $workOrder = WorkOrder::create([
                ...
                'assigned_to' => $preventiveMaintenance->assigned_to,
                ...
                'status' => $preventiveMaintenance->assigned_to ? 'assigned' : 'approved',
    ...
    public function calendar(Request $request): JsonResponse
    {
        ...
        // Plans basés sur kilométrage (afficher ceux qui sont proches du seuil)
        ...
        // Events basés sur kilométrage
        foreach ($mileagePlans as $plan) {
            $events->push([
                'id' => $plan->id,
                'title' => $plan->name,
                'code' => $plan->code,
                'date' => Carbon::today()->format('Y-m-d'), // Afficher aujourd'hui
                'asset_type' => $plan->asset_type,
                'asset_name' => $plan->asset_name,
                'asset_code' => $plan->asset_code,
                'priority' => $plan->priority,
    ...
    public function upcoming(Request $request): JsonResponse
    {
        ...
        // Plans par kilométrage (due ou due_soon)
        $mileagePlans = PreventiveMaintenance::query()
            ->where('site_id', $siteId)
            ->where('is_active', true)
            ->where('frequency_type', 'mileage')
    ...
    public function stats(Request $request): JsonResponse
    {
        ...
        // Plans en retard (par kilométrage)
    ...
    /**
     * Liste des MP pour un équipement
     */
     ...
     * (à appeler via une commande artisan/scheduler)
     */
    public function checkAndGenerate(Request $request): JsonResponse
    {
        ...
        // Plans qui nécessitent une génération
        ...
        foreach ($duePlans as $plan) {
            // Vérifier qu'il n'y a pas déjà un OT ouvert pour ce plan
