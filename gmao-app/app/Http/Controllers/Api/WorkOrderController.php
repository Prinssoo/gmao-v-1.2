...
class WorkOrderController extends Controller
{
    ...
    {
        if (!$request->user()->can('workorder:view_any')) {
    ...
    {
        if (!$request->user()->can('workorder:view')) {
            abort(403, 'Accès non autorisé');
        }
    ...
    public function update(Request $request, WorkOrder $workOrder): JsonResponse
    {
        ...
        // Suivi des changements pour l'historique
        $changes = [];
    ...
    public function destroy(Request $request, WorkOrder $workOrder): JsonResponse
    {
        ...
        // Empêcher la suppression d'un OT complété
    ...
    public function updateStatus(Request $request, WorkOrder $workOrder): JsonResponse
    {
        ...
        switch ($newStatus) {
            ...
            case 'completed':
                ...
                // Mise à jour kilométrage pour les camions
                ...
                // Calculer le coût main d'œuvre (exemple: 500 DA/heure)
                $hourlyRate = 500;
            ...
            case 'cancelled':
                ...
                // Remettre l'asset en service si était en cours
    ...
    /**
     * Liste des pièces disponibles pour ajout
     */
    ...
    public function stats(Request $request): JsonResponse
    {
        ...
        // Stats par priorité (open uniquement)
        $byPriority = [
    ...
    /**
     * Liste des OT pour un équipement
     */
    ...
    public function forTruck(Request $request, Truck $truck): JsonResponse
    {
        ...
        $workOrders = WorkOrder::where('truck_id', $truck->id)
            ->with(['assignedTo', 'requestedBy'])
            ->orderByDesc('created_at')
            ->paginate($request->per_page ?? 10);
